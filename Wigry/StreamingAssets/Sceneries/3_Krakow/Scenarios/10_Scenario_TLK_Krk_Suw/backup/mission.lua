...
function StartScenario()
    CreateCoroutine(function()
        -- Najpierw wybór pogody
        ShowMessageBox("#M_Weather", {
                ["Text"] = "#Sunny_Summer",
                ["OnClick"] = function()
                    SetStartDateTime(DateTimeCreate(2024, 06, 11, 18, 50, 00))
                ...
                ["Text"] = "#Rainy_Autumn",
                ["OnClick"] = function()
                    SetStartDateTime(DateTimeCreate(2024, 10, 28, 18, 50, 00))
                ...
                ["Text"] = "#Snowy_Winter",
                ["OnClick"] = function()
                    SetStartDateTime(DateTimeCreate(2024, 12, 28, 18, 50, 00))
        ...
        -- Teraz wybór lokomotywy i składu:
...
function Triggers()
    ...
    CreateSignalTrigger(FindSignal("Kn_F"), 500, 
    {
        ...
        result = function(trainset)
            CreateCoroutine(function()
                CreateRoute("WP_U", "WP_H", VDOrderType.TrainRoute)
                CreateRoute("WP_H", "WP_Akps", VDOrderType.TrainRoute)
            end)
        end
    })
    CreateSignalTrigger(FindSignal("WP_H"), 500, 
    {
        check = PlayerTrainsetCheck,
        result = function(trainset)
            CreateCoroutine(function()
    ...
    CreateSignalTrigger(FindSignal("Ol_G"), 500, 
    {
        ...
        result = function(trainset)
            CreateCoroutine(function()
                ...
                CreateRoute("OP_W", "OP_G", VDOrderType.TrainRoute)
                CreateRoute("OP_G", "OP_Akps", VDOrderType.TrainRoute)
            end)
        end
    })
    CreateSignalTrigger(FindSignal("OP_G"), 500, 
    {
        check = PlayerTrainsetCheck,
        result = function(trainset)
            CreateCoroutine(function()
    ...
    CreateSignalTrigger(FindSignal("Gr_H2"), 500, 
    {
        check = PlayerTrainsetCheck,
        result = function(trainset)
            CreateCoroutine(function()
...
function Ai()
    ...
    CreateSignalTrigger(FindSignal("Kz_X"), 268, 
    {
        ...
        result = function(trainset)
            ...
            SpawnTrainsetOnSignalAsync("21-ed250", FindSignal("Kz_C"), 4500, false, false, true, {
    ...
    CreateSignalTrigger(FindSignal("L4_1564"), 1720, 
    {
        ...
        result = function(trainset)
            ...
            SpawnTrainsetOnSignalAsync("30-rndWag",FindSignal("WP_J"), 180, false, false, true, CreateRandomPassengerWagonTrain(Loc.Other), function (trainset)
                trainset.SetState(DynamicState.dsStop, TrainsetState.tsTrain, true)
                Trains[30] = trainset
                Halt(trainset)
            end)
    ...
    CreateSignalTrigger(FindSignal("L4_1510"), 1038, 
    {
        ...
        result = function(trainset)
            DespawnTrainsets(false)
            SpawnTrainsetOnSignalAsync("31-ed250", FindSignal("L4_1469"), 45, false, false, true, {
                CreateNewSpawnVehicleDescriptor(LocomotiveNames.ED250_009, false)
            }, function (trainset)
                trainset.SetState(DynamicState.dsAccFast, TrainsetState.tsTrain, true)
                Trains[31] = trainset
            end)
    ...
    CreateSignalTrigger(FindSignal("L4_750"), 950, 
    {
        ...
        result = function(trainset)
            DespawnTrainsets(false)
            SpawnTrainsetOnSignalAsync("52-ed250x2", FindSignal("L4_711"), 1751, false, false, true, {
                CreateNewSpawnVehicleDescriptor(LocomotiveNames.ED250_015, false),
                CreateNewSpawnVehicleDescriptor(LocomotiveNames.ED250_018, false)
            }, function (trainset)
                trainset.SetState(DynamicState.dsAccFast, TrainsetState.tsTrain, true)
                Trains[52] = trainset
    ...
    CreateSignalTrigger(FindSignal("L4_634"), 411, 
    {
        ...
        result = function(trainset)
            DespawnTrainsets(false)
            SpawnTrainsetOnSignalAsync("54-ed250", FindSignal("L4_595"), 347, false, false, true, {
                CreateNewSpawnVehicleDescriptor(LocomotiveNames.ED250_009, false)
            }, function (trainset)
                trainset.SetState(DynamicState.dsAccFast, TrainsetState.tsTrain, true)
                Trains[54] = trainset
    ...
    CreateSignalTrigger(FindSignal("Gr_X"), 121, 
    {
        ...
        result = function(trainset)
            ...
            SpawnTrainsetOnSignalAsync("71-rndWag",FindSignal("Gr_M14"), 20, false, false, true, CreateRandomPassengerWagonTrain(Loc.Other), function (trainset)
                trainset.SetState(DynamicState.dsStop, TrainsetState.tsTrain, true)
                Trains[71] = trainset
                Halt(trainset)
            end)
    ...
    CreateSignalTrigger(FindSignal("L2_1D"), 96, 
    {
        ...
        result = function(trainset)
            ...
            SpawnTrainsetOnSignalAsync("84-ed250", FindSignal("Kz_C"), 4500, false, false, true, {
                CreateNewSpawnVehicleDescriptor(LocomotiveNames.ED250_018, false)
            }, function (trainset)
                trainset.SetState(DynamicState.dsAccFast, TrainsetState.tsTrain, true)
                Trains[84] = trainset
    ...
    if(ScenarioStep == "RadioGrodzisk") then
        if(RailstockGetPlayerTrainset().GetCurrentlyUsedChannel() == 2) then
            ...
            CreateCoroutine(function ()
                ...
                CreateRoute("Gr_X", "Gr_H2", VDOrderType.TrainRoute)
            end)
        else
            CreateCoroutine(function()
                Comms(false, "StaticNoise")
